...
commander
    ...
    .option("-s, --src <srcDir>", "sets the source folder with ts files (default: src)", "src")
    ...
    .option("-if, --ifDeclared", "If set to true, js files in dist will only be removed if a file with the same name and a .d.ts extension is also present (default: false)", false)
